...
| 2026-09-24 | (this commit) | **Progression sort tuned after render review**: artefact patterns (vestige/tome/engram/PLAN/PATTERN/cape/cloak…) checked before zone & keyword matches — vestiges no longer land in monster-drops, zone-gated cosmetics stay cosmetics, tomes/engrams leave Materials; ~70 `PLAN:`/`Plan Bundle:` furniture blueprints get their own **Plans & blueprints** group; usables widened (shield/ring/emblem/jewellery types, gems); zone group currently empty (activates on future data); determinism re-verified |
